	...
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
						...
						BDFDB.ModalUtils.open(_this, {
							...
							children: [
								BDFDB.ArrayUtils.is(_this.settings.exceptions.wordStart) && _this.settings.exceptions.wordStart.length && [
									BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.Flex, {
										...
										children: BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsLabel, {
											label: `Słowa zaczynające się od ${_this.settings.exceptions.wordStart.map(n => '"' + n + '"').join(", ")} zostaną zignorowane`
										})
									}),
								...
								BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsItem, {
									type: "Switch",
									label: "Przetłumacz swoje wiadomości przed wysłaniem",
									tag: BDFDB.LibraryComponents.FormComponents.FormTitle.Tags.H5,
		...
		return class GoogleTranslateOption extends Plugin {
			onLoad () {
				...
				this.defaults = {
					general: {
						addTranslateButton:		{value: true, 			description: "Dodaj przycisk tłumaczenia do obszaru tekstowego kanału"},
						sendOriginalMessage:	{value: false, 			description: "Wyślij oryginalną wiadomość wraz z tłumaczeniem"}
					},
					choices: {
						inputContext:			{value: "auto", 		direction: "input",		place: "Context", 		description: "Język wprowadzania w otrzymanych wiadomościach: "},
						outputContext:			{value: "$discord", 	direction: "output",	place: "Context", 		description: "Język wyjściowy w otrzymanych wiadomościach: "},
						inputMessage:			{value: "auto", 		direction: "input",		place: "Message", 		description: "Język wprowadzania w wysłanych wiadomościach: "},
						outputMessage:			{value: "$discord", 	direction: "output",	place: "Message", 		description: "Język wyjściowy w wysłanych wiadomościach: "}
					},
					exceptions: {
						wordStart:				{value: ["!"],			max: 1,		description: "Słowa zaczynające się od któregokolwiek z nich zostaną zignorowane"}
					},
					engines: {
